              ...
              <Card>
                <Card.Body>
                  ...
                  <ListGroup variant="flush" className="mb-3">
                    <ListGroup.Item><b>Next 3 Tokens:</b> {nextTokens.map(c => c.token).join(', ') || 'None'}</ListGroup.Item>
                    <ListGroup.Item><b>Last 5 Completed:</b> {lastCompleted.map(c => c.token).join(', ') || 'None'}</ListGroup.Item>
                  </ListGroup>
                  <div>
                    <b>Upcoming:</b>
                    <Table size="sm" bordered>
                      ...
                      <tbody>
                        ...
                        {nextTokens.length === 0 && <tr><td colSpan={2}>None</td></tr>}
                      </tbody>
                    </Table>
                  </div>
                  <div>
                    ...
                    <Table size="sm" bordered>
                      ...
                      <tbody>
                        ...
                        {lastCompleted.length === 0 && <tr><td colSpan={2}>None</td></tr>}
                      </tbody>
                    </Table>
                  </div>
                  <div>
                    ...
                    <Table size="sm" bordered>
                      ...
                      <tbody>
                        ...
                        {inCall.length === 0 && <tr><td colSpan={2}>None</td></tr>}
                      </tbody>
                    </Table>
                  </div>
                </Card.Body>
